...
module.exports = {
    ...
    createOrUpdate: async (req, res) => {
        try {
            ...
            if (codigo_area == 0 || codigo_area === undefined) {
                // Create new record
                const newRecord = await Area.create({
                ...
                const response = await Area.findByPk(newRecord.codigo_area);
                ...
                const record = await Area.findByPk(codigo_area);
                ...
                const updatedRecord = await Area.findByPk(codigo_area);
    ...
    getById: async (req, res) => {
        try {
            ...
            const record = await Area.findByPk(id);
